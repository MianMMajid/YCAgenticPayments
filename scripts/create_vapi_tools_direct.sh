#!/bin/bash
# Direct curl commands to create VAPI tools programmatically
# 
# Usage:
#   export VAPI_API_KEY=13c20c0e-acd5-4ccc-a617-0bcf1e95a6de
#   bash scripts/create_vapi_tools_direct.sh

VAPI_API_KEY="${VAPI_API_KEY:-13c20c0e-acd5-4ccc-a617-0bcf1e95a6de}"
VAPI_BASE_URL="https://api.vapi.ai"

echo "============================================================"
echo "Creating VAPI Tools Programmatically"
echo "============================================================"
echo ""
echo "Using API Key: ${VAPI_API_KEY:0:20}..."
echo ""

# Tool 1: search_properties
echo "1️⃣  Creating: search_properties"
...
# Tool 2: analyze_risk
echo "2️⃣  Creating: analyze_risk"
curl -X POST "$VAPI_BASE_URL/tool" \
  -H "Authorization: Bearer $VAPI_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
echo "3️⃣  Creating: schedule_viewing"
curl -X POST "$VAPI_BASE_URL/tool" \
  -H "Authorization: Bearer $VAPI_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
echo "============================================================"
echo "✅ All 4 tools sent to VAPI API!"
echo "============================================================"
echo ""
echo "Next steps:"
